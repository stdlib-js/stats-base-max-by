...
```javascript
import maxBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-max-by@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-max-by/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-max-by/actions/workflows/test.yml?query=branch:v0.1.0
